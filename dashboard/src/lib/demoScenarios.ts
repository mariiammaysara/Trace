...
export const DEMO_SCENARIOS: DemoScenario[] = [
  {
    ...
    description:
      'Real stock footage of a static street-corner traffic light. A tracked vehicle (object_id=134) crosses a calibrated tripwire line placed across the crosswalk, triggering a real LINE_CROSSED event -- verified by actually running the pipeline, not assumed.',
    cameraId: 'demo-trafficlight',
    videoName: 'demo_trafficlight.mp4',
    targetEventType: 'LINE_CROSSED',
    startTime: 8.5,
    keyLearnings:
      'Demonstrates pixel-space line-segment intersection geometry against real (non-synthetic) street footage with a static camera. This camera has only an illustrative/placeholder homography (no real-world survey exists for this stock footage), so no speed or OVERSPEED claim is made here -- only LINE_CROSSED, which is pure pixel-space geometry and does not depend on the homography scale.',
    severity: 'warning',
  },
]
